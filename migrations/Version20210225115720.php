 ...
 */
final class Version20210225115720 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE images (id INT AUTO_INCREMENT NOT NULL, id_film_id INT NOT NULL, nom VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_E01FBE6A88E2F8F3 (id_film_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE images ADD CONSTRAINT FK_E01FBE6A88E2F8F3 FOREIGN KEY (id_film_id) REFERENCES film (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE images DROP FOREIGN KEY FK_E01FBE6A88E2F8F3');
